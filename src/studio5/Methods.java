...
public class Methods {
	...
	public static double distanceBetween(double x1, double y1, double x2, double y2) {
		double dx = x2 - x1;
		double dy = y2 - y1;
		double inside = Math.pow(dx,  2) + Math.pow(dy, 2);
	...
	/**
	 * Return the mean average of an array of ints
	 * 
	 * @param array an array of integers
	 * @return value the mean average of all array values
	 */
	public static double arrayMean(int[] array) {
		double value = arraySum(array) / (double) array.length;
		return value;
	}
